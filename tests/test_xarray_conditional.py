...
def test_data_array_from_nd(sample_3ch_2pos_mixed_z):
    ...
    assert dataarray2d[0, 0, 0, 0, :, :].data.compute().tolist() == [
        [0, 0],
        [0, 128],
        [0, 0],
    ]
    assert dataarray2d[1, 0, 0, 0, :, :].data.compute().tolist() == [
        [0, 1],
        [0, 128],
        [0, 0],
    ]
    ...
    assert dataarray3d[0, 0, 0, 0, :, :].data.compute().tolist() == [
        [1, 0],
        [0, 128],
        [0, 0],
    ]
    assert dataarray3d[0, 0, 1, 0, :, :].data.compute().tolist() == [
        [2, 0],
        [0, 128],
        [0, 0],
    ]
    assert dataarray3d[1, 0, 0, 0, :, :].data.compute().tolist() == [
        [1, 1],
        [0, 128],
        [0, 0],
    ]
    assert dataarray3d[1, 0, 1, 0, :, :].data.compute().tolist() == [
        [2, 1],
        [0, 128],
        [0, 0],
    ]
